...
export default function AdminProducts() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    // 1. Resolve subcategory casing flexibility
    const targetSubcategoryId = form.subcategoryId || form.subCategoryId || "";

    // 2. Build the payload matching your schemas
    const payload = {
      name: form.name,
      ...
      // We provide both casings here just in case your frontendProductSchema
      // expects camelCase while your backend schema expects lowercase
      subcategoryId: targetSubcategoryId,
      subCategoryId: targetSubcategoryId,

      filterValueIds: form.filterValueIds || [],
      images: form.images
    ...
    if (result && result.success) {
      ...
      // CRITICAL FIX: Do NOT close the modal here!
      // Leaving it open allows the component to display the fieldErrors populated by the store.
      console.warn(
        "Product submission failed frontend validation or API constraints. Keeping modal open.",
      );
    }
  };
...
//   // Integrated Form State (Added subcategoryId and filterValueIds properties)
//   const [form, setForm] = useState({
//     id: "",
//     name: "",
//     description: "",
...
//     // Fix: Safely extract categoryId from the deeper nested subcategory if the top level field is null
//     const calculatedCategoryId =
//       product.categoryId || product.subcategory?.categoryId || "";

//     // Fix: Flatten array of objects down to simple string IDs for checkboxes
//     const mappedFilterIds = Array.isArray(product.filterValues)
//       ? product.filterValues.map((fv) => fv.id)
//       : [];
...
//       filterValueIds: mappedFilterIds,
//       images: Array.isArray(product.images)
//         ? product.images.join(", ")
//         : product.images || "",
//     });
...
//       // Provide both casings to safeguard store validations
//       subcategoryId: targetSubcategoryId,
//       subCategoryId: targetSubcategoryId,
...
//         "Are you sure you want to delete this product? This action cannot be reverted.",
//       confirmText: "Yes, Delete",
//       onConfirm: () => executeProductDeletion(id),
//     });
//   };
